...
RESOURCES += src/qt/evos.qrc src/qt/evos_locale.qrc

TRANSLATIONS += src/qt/locale/evos_bg.ts \
                src/qt/locale/evos_de.ts \
                src/qt/locale/evos_en.ts \
                src/qt/locale/evos_es.ts \
                src/qt/locale/evos_fi.ts \
                src/qt/locale/evos_fr.ts \
                src/qt/locale/evos_it.ts \
                src/qt/locale/evos_ja.ts \
                src/qt/locale/evos_pl.ts \
                src/qt/locale/evos_pt.ts \
                src/qt/locale/evos_ru.ts \
                src/qt/locale/evos_sk.ts \
                src/qt/locale/evos_sv.ts \
                src/qt/locale/evos_vi.ts \
                src/qt/locale/evos_zh_CN.ts \
                src/qt/locale/evos_zh_TW.ts
