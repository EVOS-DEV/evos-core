...
This means one can have an always-on evosd instance running, and another local evosd/evos-qt instance which connects to this node and receives blocks from it.
