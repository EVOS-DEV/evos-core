...
In order to support loading of multiple wallets in evos-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is evos.cpp.
...
Changes to evos.cpp
----------------------
evos.cpp is the entry point into evos-qt, and as such, will require some minor modifications to provide hooks for
