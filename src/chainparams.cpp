...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (131815, uint256("ba010c05af96417fe7d51e97e36274be076d1025f9e2a2189e07db9cd2660efb"));
...
public:
    CMainParams()
    {
        ...
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Evos starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Evos: 1 day  
        nTargetSpacing = 90; //90 seconds RELEASE
        nMaturity = 120;
        ...
        genesis.nVersion = 1;
        //genesis.nTime = 1533868662;  //Friday, August 10, 2018 2:37:42 AM
        genesis.nTime = 1536105600;	   // Wednesday, September 5, 2018 12:00:00 AM
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 0xf10e;
        ...
        */
        ...
        assert(hashGenesisBlock == uint256("0000dc9f1d50011d8d3328331a0687a1659a43a69cbe56bd52130ec5feec2bb2"));
        assert(genesis.hashMerkleRoot == uint256("64df8337b5e61f87f349abdcab2e412154df60c2ff314cf4c79427655530f866"));

		/*
        assert(hashGenesisBlock == uint256("000090cd5365074be4ba298c450749711f13f605b8f91056d43e8736cb61699f"));
        assert(genesis.hashMerkleRoot == uint256("64df8337b5e61f87f349abdcab2e412154df60c2ff314cf4c79427655530f866"));
        * */

        vSeeds.push_back(CDNSSeedData("seed1", "seed1.evos.one"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.evos.one"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.evos.one"));
        vSeeds.push_back(CDNSSeedData("seed4", "seed4.evos.one"));
        vSeeds.push_back(CDNSSeedData("seed5", "seed5.evos.one"));
        vSeeds.push_back(CDNSSeedData("seed6", "seed6.evos.one"));
...
{
	return "EHthFWjassMLErZWq4WgX22ZUPbw76hjrb";
}
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Evos: 1 day
        nTargetSpacing = 90;  // Evos: 1.5 minute
        nLastPOWBlock = 1199;
        nMaturity = 15;
        ...
        genesis.nTime = 1535155200;	   // Wednesday, August 25, 2018 12:00:00 AM
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 0x111e4;
 
	    hashGenesisBlock = genesis.GetHash();
        //assert(hashGenesisBlock == uint256("0000c9ea38287de37ef25faaa1440e91be0800809dc347b32ac8194501b91aa4"));

        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("testnet.evos.io", "testnet.evos.io"));         // Single node address
        //vSeeds.push_back(CDNSSeedData("testnet1.evos.io", "testnet1.evos.io"));       // Single node address
        //vSeeds.push_back(CDNSSeedData("testnet2.evos.io", "testnet2.evos.io"));       // Single node address
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Evos: 1 day
        nTargetSpacing = 90;        // Evos: 1.5 minutes
