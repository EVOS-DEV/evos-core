                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Evos Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Evos address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and evos: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zEVOS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Evos Core"), this);
    aboutAction->setStatusTip(tr("Show information about Evos Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Evos"));
    ...
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Evos addresses"));
    ...
    openAction->setStatusTip(tr("Open a Evos: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Evos Core help message to get a list with possible Evos command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Evos Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Evos network", "", count));
}
...
{
    QString strTitle = tr("Evos Core"); // default title
