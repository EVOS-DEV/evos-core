...
public:
    ...
    void setZEvosControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzEVOS_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzEVOS_clicked();
    void on_pushButtonZEvosControl_clicked();
