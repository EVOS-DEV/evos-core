                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Evos from zEvos"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zEvos"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zEvos));
...
// Cover scroll bar width with spacing
	...
	this->setStyleSheet("color:#229c86; background-color: qlineargradient(x1: 0, y1: 0, x0: 2, y0: 1, stop: 0 rgba(3,29,43, 0.9), stop: 1  rgba(89,126,133, 0.2));");
