...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Evos features */
        {"evos", "masternode", &masternode, true, true, false},
        {"evos", "listmasternodes", &listmasternodes, true, true, false},
        {"evos", "getmasternodecount", &getmasternodecount, true, true, false},
        {"evos", "masternodeconnect", &masternodeconnect, true, true, false},
        {"evos", "masternodecurrent", &masternodecurrent, true, true, false},
        {"evos", "masternodedebug", &masternodedebug, true, true, false},
        {"evos", "startmasternode", &startmasternode, true, true, false},
        {"evos", "createmasternodekey", &createmasternodekey, true, true, false},
        {"evos", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"evos", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"evos", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"evos", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"evos", "getmasternodescores", &getmasternodescores, true, true, false},
        {"evos", "mnbudget", &mnbudget, true, true, false},
        {"evos", "preparebudget", &preparebudget, true, true, false},
        {"evos", "submitbudget", &submitbudget, true, true, false},
        {"evos", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"evos", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"evos", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"evos", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"evos", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"evos", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"evos", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"evos", "checkbudgets", &checkbudgets, true, true, false},
        {"evos", "mnsync", &mnsync, true, true, false},
        {"evos", "spork", &spork, true, true, false},
        {"evos", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"evos", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use evosd, or the -server option to evos-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> evos-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:16345/\n";
}
