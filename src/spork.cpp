...
// Evos: on startup load spork values from previous session if they exist in the sporkDB
void LoadSporksFromDB()
{
    for (int i = SPORK_STEVOS; i <= SPORK_END; ++i) {
...
bool CSporkManager::CheckSignature(CSporkMessage& spork)
{
    ...
    string strSporkKey = "0409ddbda2be0200302b66d5b0d15f6997721c49b0ee1aece98d24a9cb08c6424e07fb3abf1c74a01f6e1857a6b9a1a91a501c3bd76d50b3d907e99eafadc85e39";
